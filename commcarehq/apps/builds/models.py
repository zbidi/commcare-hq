...
from commcarehq.apps.app_manager.const import APP_V1, APP_V2
from couchdbkit.exceptions import ResourceNotFound, BadValueError
from couchdbkit.ext.django.schema import *
from commcarehq.apps.builds.fixtures import commcare_build_config
from commcarehq.apps.builds.jadjar import JadJar
...
class CommCareBuild(Document):
    ...
    #>>> from commcarehq.apps.builds.models import CommCareBuild
    ...
    def get_build(cls, version, build_number=None, latest=False):
        ...
        if not self:
            raise KeyError("Can't find build {label}. For instructions on how to add it, see https://github.com/dimagi/commcare-hq/blob/master/commcarehq/apps/builds/README.md".format(label=BuildSpec(
                version=version,
