...
from commcarehq.apps.indicators.admin.forms import (FormDataAliasIndicatorDefinitionForm,
                                                FormLabelIndicatorDefinitionForm, CaseDataInFormIndicatorDefinitionForm, FormDataInCaseForm)
from commcarehq.apps.indicators.models import (FormDataAliasIndicatorDefinition,
