...
from commcarehq.apps.indicators.admin.forms import CombinedIndicatorForm
from commcarehq.apps.indicators.models import CombinedCouchViewIndicatorDefinition
