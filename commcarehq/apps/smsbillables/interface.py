...
from commcarehq.apps.accounting.filters import DateCreatedFilter
...
from commcarehq.apps.smsbillables.filters import (
    CountryCodeFilter,
    DateSentFilter,
    DirectionFilter,
    DomainFilter,
...
from commcarehq.apps.smsbillables.models import (
    SmsBillable,
    SmsGatewayFee,
...
class SMSBillablesInterface(GenericTabularReport):
    ...
    fields = [
        'commcarehq.apps.smsbillables.interface.DateSentFilter',
        'commcarehq.apps.accounting.interface.DateCreatedFilter',
        'commcarehq.apps.smsbillables.interface.ShowBillablesFilter',
        'commcarehq.apps.smsbillables.interface.DomainFilter',
    ]
...
class SMSGatewayFeeCriteriaInterface(GenericTabularReport):
    ...
    exportable_all = True
    fields = [
        'commcarehq.apps.smsbillables.interface.GatewayTypeFilter',
        'commcarehq.apps.smsbillables.interface.SpecificGateway',
        'commcarehq.apps.smsbillables.interface.DirectionFilter',
        'commcarehq.apps.smsbillables.interface.CountryCodeFilter',
    ]
