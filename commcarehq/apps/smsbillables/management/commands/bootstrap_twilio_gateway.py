...
from commcarehq.apps.twilio.models import TwilioBackend
from commcarehq.apps.sms.models import OUTGOING
...
def bootstrap_twilio_gateway(orm):
    ...
    # iso -> provider -> rate
    def get_twilio_data():
        twilio_file = open('commcarehq/apps/smsbillables/management/'
    ...
    def get_mach_data():
        mach_workbook = xlrd.open_workbook('commcarehq/apps/smsbillables/management/'
