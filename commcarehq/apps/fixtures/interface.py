...
from commcarehq.apps.fixtures.views import fixtures_home, FixtureViewMixIn
...
from commcarehq.apps.fixtures.dispatcher import FixtureInterfaceDispatcher
from commcarehq.apps.fixtures.models import FixtureDataType, _id_from_doc
...
class FixtureViewInterface(GenericTabularReport, FixtureInterface):
    ...
    fields = ['commcarehq.apps.fixtures.interface.FixtureSelectFilter']
    ...
    @memoized
    def table(self):
        from commcarehq.apps.fixtures.views import data_table
