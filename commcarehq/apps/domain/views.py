...
from commcarehq.apps.accounting.async_handlers import Select2BillingInfoHandler
from commcarehq.apps.accounting.decorators import (
    require_billing_admin, requires_privilege_with_fallback,
)
from commcarehq.apps.accounting.exceptions import PaymentRequestError
from commcarehq.apps.accounting.payment_handlers import (
    InvoiceStripePaymentHandler, CreditStripePaymentHandler,
)
from commcarehq.apps.accounting.subscription_changes import DomainDowngradeStatusHandler
from commcarehq.apps.accounting.forms import EnterprisePlanContactForm
from commcarehq.apps.accounting.utils import (
    get_change_status, get_privileges, fmt_dollar_amount,
    quantize_accounting_decimal, get_customer_cards,
)
from commcarehq.apps.hqwebapp.async_handler import AsyncHandlerMixin
from commcarehq.apps.smsbillables.async_handlers import SMSRatesAsyncHandler, SMSRatesSelect2AsyncHandler
from commcarehq.apps.smsbillables.forms import SMSRateCalculatorForm
from commcarehq.apps.users.models import DomainInvitation
from commcarehq.apps.fixtures.models import FixtureDataType
from commcarehq.toggles import NAMESPACE_DOMAIN, all_toggles, CAN_EDIT_EULA, TRANSFER_DOMAIN
from commcarehq.util.context_processors import get_domain_type
...
from commcarehq import privileges, feature_previews, toggles
from django_prbac.decorators import requires_privilege_raise404
from django_prbac.utils import has_privilege

from commcarehq.apps.accounting.models import (
...
from commcarehq.apps.accounting.usage import FeatureUsageCalculator
from commcarehq.apps.accounting.user_text import get_feature_name, PricingTable, DESC_BY_EDITION
from commcarehq.apps.hqwebapp.models import ProjectSettingsTab
from commcarehq.apps import receiverwrapper
from django.core.urlresolvers import reverse
from django.http import HttpResponseRedirect, HttpResponse, Http404

from django.shortcuts import redirect, render
from commcarehq.apps.domain.calculations import CALCS, CALC_FNS, CALC_ORDER, dom_calc
...
from commcarehq.apps.domain.forms import (
...
from commcarehq.apps.domain.models import Domain, LICENSES, TransferDomainRequest
from commcarehq.apps.domain.utils import normalize_domain_name
from commcarehq.apps.hqwebapp.views import BaseSectionPageView, BasePageView, CRUDPaginatedViewMixin
from commcarehq.apps.orgs.models import Organization, OrgRequest, Team
from commcarehq.apps.domain.forms import ProjectSettingsForm
from dimagi.utils.decorators.memoized import memoized
from dimagi.utils.django.email import send_HTML_email

from dimagi.utils.web import get_ip, json_response, get_site_domain
from commcarehq.apps.users.decorators import require_can_edit_web_users
from commcarehq.apps.receiverwrapper.forms import GenericRepeaterForm, FormRepeaterForm
from commcarehq.apps.receiverwrapper.models import FormRepeater, CaseRepeater, ShortFormRepeater, AppStructureRepeater, \
    RepeatRecord
...
def incomplete_email(request,
    ...
    from commcarehq.apps.domain.tasks import (
