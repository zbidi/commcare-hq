...
from commcarehq.apps.accounting.exceptions import SubscriptionRenewalError
from commcarehq.apps.accounting.utils import domain_has_privilege
from commcarehq.apps.sms.phonenumbers_helper import parse_phone_number
...
from commcarehq.apps.app_manager.models import Application, FormBase, RemoteApp, get_apps_in_domain

from commcarehq.apps.domain.models import (LOGO_ATTACHMENT, LICENSES, DATA_DICT,
...
from commcarehq.apps.style.forms.widgets import BootstrapCheckboxInput, BootstrapDisabledInput
import django
...
class ConfirmNewSubscriptionForm(EditBillingAccountInfoForm):
    ...
    def __init__(self, account, domain, creating_user, plan_version, current_subscription, data=None, *args, **kwargs):
        ...
        from commcarehq.apps.domain.views import DomainSubscriptionView
        self.helper.layout = crispy.Layout(
            'plan_edition',
            crispy.Fieldset(
                _("Billing Administrators"),
