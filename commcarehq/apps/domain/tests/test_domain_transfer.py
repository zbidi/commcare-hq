...
from commcarehq.apps.domain.models import Domain, TransferDomainRequest
from commcarehq.apps.domain.forms import TransferDomainForm, TransferDomainFormErrors
from commcarehq.apps.domain.views import TransferDomainView
from commcarehq.apps.domain.exceptions import InactiveTransferDomainException
