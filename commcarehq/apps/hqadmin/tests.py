...
# CCHQ imports
from commcarehq.apps.hqadmin.management.commands import cchq_prbac_bootstrap
...
class TestPillowTopFiltering(SimpleTestCase):
    ...
    def test_no_blacklist_items(self):
        expected_pillows = {u'commcarehq.pillows.case.CasePillow',
                            u'commcarehq.pillows.xform.XFormPillow',
                            u'commcarehq.pillows.domain.DomainPillow',
                            u'commcarehq.pillows.user.UserPillow',
                            u'commcarehq.pillows.application.AppPillow',
                            u'commcarehq.pillows.group.GroupPillow',
                            u'commcarehq.pillows.sms.SMSPillow',
                            u'commcarehq.pillows.user.GroupToUserPillow',
                            u'commcarehq.pillows.user.UnknownUsersPillow',
                            u'commcarehq.pillows.sofabed.FormDataPillow',
                            u'commcarehq.pillows.sofabed.CaseDataPillow',
                            u'commcarehq.pillows.log.PhoneLogPillow'}
