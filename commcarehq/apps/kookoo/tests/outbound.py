...
from commcarehq.apps.sms.tests.util import TouchformsTestCase
from commcarehq.apps.sms.mixin import MobileBackend
from commcarehq.apps.sms.models import CallLog
...
class KooKooTestCase(TouchformsTestCase):
    """
    Must be run manually (see commcarehq.apps.sms.tests.util.TouchformsTestCase)
    """
    ...
    def setUp(self):
        ...
        self.ivr_backend = MobileBackend(
            ...
            outbound_module="commcarehq.apps.kookoo.api",
