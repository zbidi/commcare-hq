...
from commcarehq.apps.smsforms.models import XFORMS_SESSION_IVR
from commcarehq.apps.smsforms.util import form_requires_input
from commcarehq.apps.ivr.api import format_ivr_response, get_input_length
...
def initiate_outbound_call(call_log_entry, *args, **kwargs):
    ...
    params = urlencode({
        ...
        "outbound_version" : "2",
        "url" : url_base + reverse("commcarehq.apps.kookoo.views.ivr"),
        "callback_url" : url_base + reverse("commcarehq.apps.kookoo.views.ivr_finished"),
    })
