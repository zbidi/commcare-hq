...
EXAMPLES_PATH = 'commcarehq/apps/styleguide/examples/'
TEMPLATE_PATH = 'commcarehq/apps/styleguide/templates/styleguide/examples'
DOCS_TEMPLATE_PATH = 'commcarehq/apps/styleguide/templates/styleguide/docs'
