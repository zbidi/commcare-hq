...
from commcarehq.apps.styleguide.examples.controls_demo.views import (
    DefaultControlsDemoFormsView,
    SelectControlDemoView,
)
from commcarehq.apps.hqwebapp.models import UITab, dropdown_dict
from commcarehq.apps.styleguide.examples.simple_crispy_form.views import (
    DefaultSimpleCrispyFormSectionView,
    SimpleCrispyFormView,
)
from commcarehq.apps.styleguide.views import (
    MainStyleGuideView,
    FormsStyleGuideView,
)
from commcarehq.apps.styleguide.views.docs import (
...
class SGExampleTab(BaseSGTab):
    ...
    view = 'commcarehq.apps.styleguide.views.docs.default'
    subtab_classes = (
