...
doc_urlpatterns = patterns('commcarehq.apps.styleguide.views.docs',
    url(r'^$', 'default', name='sg_examples_default'),
    url(r'^simple_crispy/',
        include('commcarehq.apps.styleguide.examples.simple_crispy_form.urls')),
    url(r'^controls_demo/',
        include('commcarehq.apps.styleguide.examples.controls_demo.urls')),
)

urlpatterns = patterns('commcarehq.apps.styleguide.views',
