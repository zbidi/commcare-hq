...
from commcarehq.pillows.reportxform import ReportXFormPillow

from couchforms.models import XFormInstance
from casexml.apps.case.models import CommCareCase

from commcarehq.pillows.xform import XFormPillow
...
from commcarehq.apps.receiverwrapper.models import FormRepeater, CaseRepeater, ShortFormRepeater
from commcarehq.apps.api.resources import v0_1, v0_4, v0_5
from commcarehq.apps.api.fields import ToManyDocumentsField, ToOneDocumentField, UseIfRequested, ToManyDictField
from commcarehq.apps.api import es
from commcarehq.apps.api.es import ESQuerySet, ESUserError
...
class ToManySourceResource(Resource):
    ...
    other_models = ToManyDocumentsField('commcarehq.apps.api.tests.ToManyDestResource', attribute='other_models')
...
class ToManyDictSourceResource(Resource):
    other_model_ids = fields.ListField(attribute='other_model_ids')
    other_models = ToManyDictField('commcarehq.apps.api.tests.ToManyDictDestResource', attribute='other_models')
...
class ToOneSourceResource(Resource):
    ...
    other_model = ToOneDocumentField('commcarehq.apps.api.tests.ToOneDestResource', attribute='other_model')
