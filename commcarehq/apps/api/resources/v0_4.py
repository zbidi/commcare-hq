...
from commcarehq.apps.api.resources.v0_1 import CustomResourceMeta, RequirePermissionAuthentication, \
    _safe_bool
...
from commcarehq.apps.api.util import get_object_or_not_exist
from commcarehq.apps.app_manager import util as app_manager_util
from commcarehq.apps.app_manager.models import get_apps_in_domain, Application, RemoteApp, Form, get_app
from commcarehq.apps.receiverwrapper.models import Repeater, repeater_types
from commcarehq.apps.groups.models import Group
from commcarehq.apps.cloudcare.api import ElasticCaseQuery
from commcarehq.apps.users.util import format_username
from commcarehq.apps.users.models import CouchUser, Permissions

from commcarehq.apps.api.resources import v0_1, v0_3, HqBaseResource, DomainSpecificResourceMixin, \
    SimpleSortableResourceMixin
from commcarehq.apps.api.es import XFormES, CaseES, ESQuerySet, es_search
from commcarehq.apps.api.fields import ToManyDocumentsField, UseIfRequested, ToManyDictField, ToManyListDictField
from commcarehq.apps.api.serializers import CommCareCaseSerializer
...
class XFormInstanceResource(SimpleSortableResourceMixin, v0_3.XFormInstanceResource, DomainSpecificResourceMixin):
    ...
    cases = UseIfRequested(ToManyDocumentsField('commcarehq.apps.api.resources.v0_4.CommCareCaseResource',
...
class CommCareCaseResource(SimpleSortableResourceMixin, v0_3.CommCareCaseResource, DomainSpecificResourceMixin):
    ...
    xforms_by_name = UseIfRequested(ToManyListDictField(
        'commcarehq.apps.api.resources.v0_4.XFormInstanceResource',
    ...
    child_cases = UseIfRequested(ToManyDictField('commcarehq.apps.api.resources.v0_4.CommCareCaseResource',
                                                 attribute=lambda case: dict([ (index.identifier, CommCareCase.get(index.referenced_id)) for index in case.indices])))

    parent_cases = UseIfRequested(ToManyDictField('commcarehq.apps.api.resources.v0_4.CommCareCaseResource',
