...
from commcarehq.apps.reports.filters.forms import FormsByApplicationFilter
from commcarehq.elastic import get_es, ESError
from commcarehq.pillows.base import restore_property_dict, VALUE_TAG
...
class ESView(View):
    ...
    Access to the APIs can be done via url endpoints which are attached to the commcarehq.api.urls
