from commcarehq.apps.api.domain_metadata import DomainMetadataResource
from commcarehq.apps.api.object_fetch_api import CaseAttachmentAPI

from commcarehq.apps.api.domainapi import DomainAPI
from commcarehq.apps.api.redis_assets import RedisAssetsAPI
from commcarehq.apps.api.resources import v0_1, v0_2, v0_3, v0_4, v0_5
from commcarehq.apps.commtrack.resources.v0_1 import ProductResource
from commcarehq.apps.fixtures.resources.v0_1 import FixtureResource
from commcarehq.apps.locations.resources.v0_1 import LocationResource
from commcarehq.apps.reports.resources.v0_1 import ReportResource
from django.conf.urls import *
from django.http import HttpResponseNotFound
from tastypie.api import Api
from commcarehq.apps.api.es import XFormES
