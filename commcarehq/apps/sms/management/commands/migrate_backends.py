...
from commcarehq.apps.sms.mixin import MobileBackend
from commcarehq.apps.mach.api import MachBackend
from commcarehq.apps.unicel.api import UnicelBackend
from commcarehq.apps.tropo.api import TropoBackend
from commcarehq.apps.sms.backend.http_api import HttpBackend
    ...
    def handle(self, *args, **options):
        ...
        for backend in backends:
            ...
            if backend._id == "MOBILE_BACKEND_UNICEL":
                ...
                backend.outbound_params = None
                backend.save()
            elif backend.outbound_module == "commcarehq.apps.tropo.api":
                ...
                backend.outbound_params = None
                backend.save()
            elif backend.outbound_module == "commcarehq.apps.sms.backend.http_api":
                ...
                backend.outbound_params = None
                backend.save()
            elif backend.outbound_module == "commcarehq.apps.sms.test_backend":
