...
class MobileBackend(Document):
    ...
    def load(cls, backend_id):
        ...
        """
        # Circular import
        from commcarehq.apps.sms.util import get_available_backends
    ...
    def get_form_class(cls):
        """
        This method should return a subclass of commcarehq.apps.sms.forms.BackendForm
        """
...
class SMSBackend(MobileBackend):
    ...
    def get_sms_interval(self):
        ...
        timeout. See commcarehq.apps.sms.tasks.handle_outgoing.
