...
from commcarehq.apps.sms import util as smsutil
...
class MessageLog(SafeSaveDocument, UnicodeMixIn):
    ...
    xforms_session_couch_id = StringProperty() # Points to the _id of an instance of commcarehq.apps.smsforms.models.XFormsSession that this sms is tied to
    reminder_id = StringProperty() # Points to the _id of an instance of commcarehq.apps.reminders.models.CaseReminder that this sms is tied to
