...
from commcarehq.apps.smsforms.app import _get_responses, start_session
from commcarehq.apps.sms.models import WORKFLOW_KEYWORD
from commcarehq.apps.sms.messages import *
from commcarehq.apps.sms.handlers.form_session import validate_answer
from commcarehq.apps.smsforms.models import SQLXFormsSession
...
from commcarehq.apps.reminders.util import create_immediate_reminder
from commcarehq.apps.users.cases import get_owner_id, get_wrapped_owner
...
def global_keyword_start(v, text, msg, text_words, open_sessions):
    from commcarehq.apps.reminders.models import SurveyKeyword
