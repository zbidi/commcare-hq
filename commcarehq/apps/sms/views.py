...
from commcarehq.apps.accounting.decorators import requires_privilege_with_fallback, requires_privilege_plaintext_response
from commcarehq.apps.api.models import require_api_user_permission, PERMISSION_POST_SMS
from commcarehq.apps.commtrack.models import AlertConfig
from commcarehq.apps.sms.api import (
    send_sms,
    incoming,
...
from commcarehq.apps.hqwebapp.views import CRUDPaginatedViewMixin
from commcarehq.apps.users.decorators import require_permission
from commcarehq.apps.users.models import CouchUser, Permissions
from commcarehq.apps.users import models as user_models
from commcarehq.apps.users.views.mobile.users import EditCommCareUserView
from commcarehq.apps.sms.models import (
    SMSLog, INCOMING, OUTGOING, ForwardingRule,
    LastReadMessage,
)
from commcarehq.apps.sms.mixin import (SMSBackend, BackendMapping, VerifiedNumber,
    SMSLoadBalancingMixin)
from commcarehq.apps.sms.forms import (ForwardingRuleForm, BackendMapForm,
    InitiateAddSMSBackendForm, SubscribeSMSForm,
    SettingsForm, SHOW_ALL, SHOW_INVALID, HIDE_ALL, ENABLED, DISABLED,
    DEFAULT, CUSTOM)
from commcarehq.apps.sms.util import get_available_backends, get_contact
from commcarehq.apps.sms.messages import _MESSAGES
from commcarehq.apps.groups.models import Group
from commcarehq.apps.domain.decorators import login_and_domain_required, login_or_digest, domain_admin_required, require_superuser
from commcarehq.apps.translations.models import StandaloneTranslationDoc
...
def edit_sms_languages(request, domain):
    """
    Accepts same post body as commcarehq.apps.app_manager.views.edit_app_langs
    """
    with StandaloneTranslationDoc.get_locked_obj(domain, "sms",
        create=True) as tdoc:
        try:
            from commcarehq.apps.app_manager.views import validate_langs
