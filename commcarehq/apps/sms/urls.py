...
from commcarehq import SMSAdminInterfaceDispatcher
...
urlpatterns = patterns('commcarehq.apps.sms.views',
...
sms_admin_interface_urls = patterns('commcarehq.apps.sms.views',
