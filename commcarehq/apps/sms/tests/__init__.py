...
from commcarehq.apps.accounting.models import BillingAccount, DefaultProductPlan, SoftwarePlanEdition, Subscription
from commcarehq.apps.domain.calculations import num_mobile_users
from commcarehq.apps.domain.models import Domain
from commcarehq.apps.sms.mixin import SMSBackend, BackendMapping, BadSMSConfigException
from commcarehq.apps.sms.api import send_sms, send_sms_to_verified_number, send_sms_with_backend, send_sms_with_backend_name, \
    incoming
from commcarehq.apps.sms.models import CommConnectCase
...
class BackendTestCase(TestCase):
    ...
    def setUp(self):
        ...
        settings.SMS_LOADED_BACKENDS.append("commcarehq.apps.sms.tests.TestCaseBackend")
