...
from commcarehq.apps.app_manager.tests import TestFileMixin
from commcarehq.apps.hqcase.tasks import explode_cases
from commcarehq.apps.hqcase.utils import make_creating_casexml, submit_case_blocks, \
...
TESTS = (
    (
        CommCareCase(
            ...
            case_attachments={
                'fruity_file': CommCareCaseAttachment(
                    ...
                    attachment_src=u'./commcarehq/ex-submodules/casexml/apps/case/tests/data/attachments/fruity.jpg',
        ...
        {u'fruity_file': u'./commcarehq/ex-submodules/casexml/apps/case/tests/data/attachments/fruity.jpg'},
        """
        <case case_id="new-case-abc123" date_modified="2011-12-20T00:11:02Z"
            ...
            <attachment>
                <fruity_file from="local" src="./commcarehq/ex-submodules/casexml/apps/case/tests/data/attachments/fruity.jpg"/>
            </attachment>
        </case>
        """
    ),
