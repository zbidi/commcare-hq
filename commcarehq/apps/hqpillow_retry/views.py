...
from commcarehq.apps.hqpillow_retry.filters import DatePropFilter, AttemptsFilter, PillowErrorFilter
...
class PillowErrorsReport(GenericTabularReport, DatespanMixin, GetParamsMixin):
    ...
    fields = (
        ...
        'commcarehq.apps.hqpillow_retry.filters.DatePropFilter',
        'commcarehq.apps.hqpillow_retry.filters.PillowErrorFilter',
        'commcarehq.apps.hqpillow_retry.filters.AttemptsFilter',
    )
