...
from commcarehq.apps.commtrack.const import USER_LOCATION_OWNER_MAP_TYPE
from casexml.apps.phone.models import User as CaseXMLUser
from commcarehq.apps.cachehq.mixins import CachedCouchDocumentMixin
from commcarehq.apps.domain.shortcuts import create_user
from commcarehq.apps.domain.utils import normalize_domain_name, domain_restricts_superusers
from commcarehq.apps.domain.models import LicenseAgreement
from commcarehq.apps.users.util import normalize_username, user_data_from_registration_form
from commcarehq.apps.users.xml import group_fixture
from commcarehq.apps.users.tasks import tag_docs_as_deleted
from commcarehq.apps.users.exceptions import InvalidLocationConfig
from commcarehq.apps.sms.mixin import (
...
class Permissions(DocumentSchema):
    ...
    def wrap(cls, data):
        ...
        MOVED_REPORT_MAPPING = {
            'commcarehq.apps.reports.standard.inspect.CaseListReport': 'commcarehq.apps.reports.standard.cases.basic.CaseListReport'
        }
...
class UserRole(Document):
    ...
    def ids_of_assigned_users(self):
        from commcarehq.apps.api.es import UserES
            ...
            if contact:
                ...
                try:
                    ...
                    try:
                        ...
                        from commcarehq.apps.users.views.mobile import EditCommCareUserView
...
class LocationUserMixin(DocumentSchema):
    ...
    def set_location(self, location):
        ...
        from commcarehq.apps.locations.models import LOCATION_SHARING_PREFIX
    ...
    def supply_point_index_mapping(self, supply_point, clear=False):
        from commcarehq.apps.commtrack.exceptions import (
    ...
    def add_location(self, location, create_sp_if_missing=False):
        ...
        if not location.location_type_object.administrative:
            from commcarehq.apps.commtrack.util import submit_mapping_case_block
            submit_mapping_case_block(self, self.supply_point_index_mapping(sp))

    def submit_location_block(self, caseblock):
        from commcarehq.apps.hqcase.utils import submit_case_blocks
    ...
    def create_location_delegates(self, locations):
        ...
        from commcarehq.apps.commtrack.util import location_map_case_id
        caseblock = CaseBlock(
            create=True,
...
#            self.save() # will uncomment when I figure out what's happening with sheels commcareuser
    ...
    def filter_flag(self):
        from commcarehq.apps.reports.models import HQUserType
...
class OrgMembershipMixin(DocumentSchema):
    ...
    def get_organizations(self):
        from commcarehq.apps.orgs.models import Organization
    ...
    def add_to_team(self, org, team_id):
        ...
        from commcarehq.apps.orgs.models import Team
