from commcarehq.apps.commtrack.tests.util import CommTrackTest, make_loc
from commcarehq.apps.commtrack.helpers import make_supply_point
from commcarehq.apps.users.bulkupload import UserLocMapping, SiteCodeToSupplyPointCache
from commcarehq.apps.users.models import CommCareUser
from mock import patch
from commcarehq.toggles import MULTIPLE_LOCATIONS_PER_USER, NAMESPACE_DOMAIN
...
class UserLocMapTest(CommTrackTest):
    ...
    def test_should_not_add_what_is_already_there(self):
        ...
        with patch('commcarehq.apps.hqcase.utils.submit_case_blocks') as submit_blocks:
            self.mapping.save()
    ...
    def test_location_lookup_caching(self):
        ...
        with patch('commcarehq.apps.commtrack.util.SupplyPointCase.get_by_location') as get_supply_point:
            self.mapping.save()
            mapping2.save()
