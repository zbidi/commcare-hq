...
from commcarehq.apps.domain.forms import EditBillingAccountInfoForm
from commcarehq.apps.domain.models import Domain
from commcarehq.apps.locations.models import Location, LOCATION_SHARING_PREFIX
from commcarehq.apps.registration.utils import handle_changed_mailchimp_email
from commcarehq.apps.users.models import CouchUser
from commcarehq.apps.users.util import format_username
from commcarehq.apps.app_manager.models import validate_lang
...
from commcarehq.apps.style import crispy as hqcrispy
...
class SupplyPointSelectWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None):
        return get_template('locations/manage/partials/autocomplete_select_widget.html').render(Context({
                    ...
                    'query_url': reverse('commcarehq.apps.commtrack.views.api_query_supply_point', args=[self.domain]),
                }))
...
class ConfirmExtraUserChargesForm(EditBillingAccountInfoForm):
    ...
    def __init__(self, account, domain, creating_user, data=None, *args, **kwargs):
        ...
        from commcarehq.apps.users.views.mobile import ListCommCareUsersView
