...
from commcarehq import Domain, privileges, toggles
from commcarehq.apps.accounting.utils import domain_has_privilege
from commcarehq.apps.domain.views import BaseDomainView
from commcarehq.apps.sms.mixin import BadSMSConfigException
from commcarehq.apps.style.decorators import (
    check_preview_bootstrap3,
    use_knockout_js,
)
from commcarehq.apps.users.decorators import require_can_edit_web_users, require_permission_to_edit_user
from commcarehq.apps.users.util import smart_query_string
from commcarehq.elastic import ADD_TO_ES_FILTER, es_query, ES_URLS
...
from commcarehq.apps.registration.forms import AdminInvitesUserForm
from commcarehq.apps.hqwebapp.utils import InvitationView
from commcarehq.apps.users.forms import (UpdateUserRoleForm, BaseUserInfoForm, UpdateMyAccountInfoForm, CommtrackUserForm, UpdateUserPermissionForm)
...
from commcarehq.apps.domain.decorators import (login_and_domain_required, require_superuser, domain_admin_required)
from commcarehq.apps.orgs.models import Team
from commcarehq.apps.reports.util import get_possible_reports
from commcarehq.apps.sms import verify as smsverify
...
class BaseUserSettingsView(BaseDomainView):
    ...
    def section_url(self):
        from commcarehq.apps.users.views import DefaultProjectUserSettingsView
