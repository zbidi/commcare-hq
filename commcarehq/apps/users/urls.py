...
from commcarehq.apps.domain.utils import grandfathered_domain_re
...
urlpatterns = patterns('commcarehq.apps.users.views',
...
patterns("commcarehq.apps.users.views.mobile.users",
...
patterns("commcarehq.apps.users.views.mobile.groups",
