...
from commcarehq.apps.consumption.shortcuts import (get_default_consumption, set_default_monthly_consumption_for_domain,
...
from commcarehq.apps.consumption.const import DAYS_IN_MONTH
