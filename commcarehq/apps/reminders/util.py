...
from commcarehq.apps.app_manager.models import get_app, ApplicationBase, Form
...
def enqueue_reminder_directly(reminder):
    from commcarehq.apps.reminders.management.commands.run_reminder_queue import (
...
def create_immediate_reminder(contact, content_type, reminder_type=None, message=None, form_unique_id=None, case=None):
    ...
    content_type - METHOD_SMS or METHOD_SMS_SURVEY (see commcarehq.apps.reminders.models)
