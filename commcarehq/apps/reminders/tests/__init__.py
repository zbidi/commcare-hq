...
from commcarehq.apps.reminders.event_handlers import get_message_template_params
from commcarehq.apps.users.models import CouchUser, CommCareUser
from commcarehq.apps.sms.models import CallLog, ExpectedCallbackEventLog, CALLBACK_RECEIVED, CALLBACK_PENDING, CALLBACK_MISSED
from commcarehq.apps.sms.mixin import VerifiedNumber, BackendMapping
