...
from commcarehq.apps.reminders.util import get_form_name, enqueue_reminder_directly
from couchdbkit.exceptions import ResourceConflict
from couchdbkit.resource import ResourceNotFound
from commcarehq.apps.sms.util import create_task, close_task, update_task
...
class CaseReminderHandler(Document):
    ...
    def fire(self, reminder):
        ...
        if isinstance(recipient, list) and len(recipient) > 0:
            ...
            from commcarehq.apps.reminders.event_handlers import raise_error, ERROR_NO_RECIPIENTS
    ...
    def save(self, **params):
        from commcarehq.apps.reminders.tasks import process_reminder_rule
        self.check_state()
