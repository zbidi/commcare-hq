...
from commcarehq.apps.reminders.util import DotExpandedDict, get_form_list
from casexml.apps.case.models import CommCareCaseGroup
from commcarehq.apps.groups.models import Group
from commcarehq.apps.hqwebapp.crispy import (
...
from commcarehq.apps.app_manager.models import Form as CCHQForm
...
class BaseScheduleCaseReminderForm(forms.Form):
    ...
    def __init__(self, data=None, is_previewer=False,
        ...
        from commcarehq.apps.reminders.views import RemindersListView
...
class KeywordForm(Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from commcarehq.apps.reminders.views import KeywordsListView
        self.helper = FormHelper()
