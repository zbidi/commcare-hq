...
from commcarehq.apps.locations.bulk import LocationImporter
from mock import patch
from commcarehq.apps.consumption.shortcuts import get_default_consumption
...
class LocationImportTest(CommTrackTest):
    ...
    def test_shouldnt_save_if_no_changes(self):
        ...
        with patch('commcarehq.apps.locations.forms.LocationForm.save') as save:
            result = import_location(self.domain.name, 'outlet', data)
