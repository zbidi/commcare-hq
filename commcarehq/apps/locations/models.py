...
from commcarehq.apps.commtrack.const import COMMTRACK_USERNAME
...
class SQLLocation(MPTTModel):
    ...
    def _make_group_object(self, user_id, case_sharing):
        ...
        from commcarehq.apps.groups.models import UnsavableGroup
...
class Location(CachedCouchDocumentMixin, Document):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.site_code:
            from commcarehq.apps.commtrack.util import generate_code
