...
from commcarehq.apps.locations.models import Location, root_locations
from commcarehq.apps.api.resources.v0_1 import CustomResourceMeta, LoginAndDomainAuthentication
