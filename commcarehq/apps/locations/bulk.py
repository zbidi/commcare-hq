...
from commcarehq.apps.consumption.shortcuts import get_default_consumption, set_default_consumption_for_supply_point
from commcarehq.apps.commtrack.models import SupplyPointCase
from commcarehq.apps.products.models import Product
from commcarehq.apps.custom_data_fields.edit_entity import add_prefix
...
def top_level_location_types(domain):
    ...
    """
    from commcarehq.apps.locations.util import location_hierarchy_config
