...
from commcarehq.apps.commtrack.const import is_supply_point_form, RequisitionStatus
from commcarehq.apps.commtrack.models import RequisitionCase, CommtrackConfig, SupplyPointCase
from commcarehq.apps.commtrack.util import bootstrap_commtrack_settings_if_necessary
...
def send_notifications(xform, cases):
    ...
    from commcarehq.apps.commtrack.requisitions import get_notification_recipients
