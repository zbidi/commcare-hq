...
from commcarehq.apps.hqwebapp.forms import FormListForm
from commcarehq.apps.products.models import Product
from commcarehq.apps.consumption.shortcuts import set_default_consumption_for_product, get_default_monthly_consumption
from commcarehq.toggles import LOCATION_TYPE_STOCK_RATES
...
class CommTrackSettingsForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from commcarehq.apps.locations.views import LocationImportView
        url = reverse(
