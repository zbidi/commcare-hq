...
from commcarehq.apps.commtrack.models import ConsumptionConfig, StockRestoreConfig, RequisitionCase, StockState
from commcarehq.apps.products.models import Product
from commcarehq.apps.consumption.shortcuts import set_default_monthly_consumption_for_domain
from couchforms.models import XFormInstance
from dimagi.utils.parsing import json_format_datetime
from casexml.apps.stock import const as stockconst
from casexml.apps.stock.models import StockReport, StockTransaction
from commcarehq.apps.commtrack import const
from commcarehq.apps.commtrack.tests.util import CommTrackTest, get_ota_balance_xml, FIXED_USER, extract_balance_xml
...
from commcarehq.apps.commtrack.tests.util import make_loc, make_supply_point
from commcarehq.apps.commtrack.const import DAYS_IN_MONTH
from commcarehq.apps.commtrack.requisitions import get_notification_message
from commcarehq.apps.commtrack.tests.data.balances import (
    balance_ota_block,
    submission_wrap,
    balance_submission,
    transfer_dest_only,
