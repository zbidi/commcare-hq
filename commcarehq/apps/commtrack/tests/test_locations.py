...
from commcarehq.apps.commtrack.tests.util import CommTrackTest, make_loc, FIXED_USER
...
class MultiLocationsTest(CommTrackTest):
    ...
    def test_location_removal_only_submits_if_it_existed(self):
        ...
        with patch('commcarehq.apps.users.models.CommCareUser.submit_location_block') as submit_blocks:
            user.remove_location(loc)
