...
from commcarehq.apps.commtrack.models import CommtrackConfig, ConsumptionConfig, StockRestoreConfig
from commcarehq.apps.commtrack.tests.util import bootstrap_domain
