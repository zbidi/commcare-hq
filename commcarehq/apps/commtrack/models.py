...
from commcarehq.apps.consumption.shortcuts import get_default_monthly_consumption
...
from commcarehq.apps.locations.signals import location_created, location_edited
...
from commcarehq.apps.commtrack.const import StockActions, RequisitionActions, RequisitionStatus, DAYS_IN_MONTH
from commcarehq.apps.commtrack.xmlutil import XML
...
def reprocess_form(sender, xform, *args, **kwargs):
    from commcarehq.apps.commtrack.processing import process_stock
