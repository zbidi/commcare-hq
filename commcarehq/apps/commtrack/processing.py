...
from commcarehq.apps.commtrack.models import CommtrackConfig, NewStockReport
from dimagi.utils.couch.loosechange import map_reduce
from commcarehq.apps.commtrack.util import wrap_commtrack_case
...
def process_stock(xform, case_db=None):
    ...
    from commcarehq.apps.commtrack.signals import send_notifications, raise_events
