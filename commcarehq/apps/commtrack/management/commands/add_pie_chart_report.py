...
from commcarehq.apps.domain.models import Domain, DynamicReportSet, DynamicReportConfig
    ...
    def handle(self, *args, **options):
        ...
        def _make_report():
            ...
            return DynamicReportConfig(
                report='commcarehq.apps.reports.standard.inspect.GenericPieChartReportTemplate',
                name=report_name,
