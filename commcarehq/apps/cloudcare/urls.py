...
from commcarehq.apps.cloudcare.views import EditCloudcareUserPermissionsView

app_urls = patterns('commcarehq.apps.cloudcare.views',
...
settings_urls = patterns('commcarehq.apps.cloudcare.views',
    url(r'^app/', EditCloudcareUserPermissionsView.as_view(), name=EditCloudcareUserPermissionsView.urlname),
)

urlpatterns = patterns('commcarehq.apps.cloudcare.views',
