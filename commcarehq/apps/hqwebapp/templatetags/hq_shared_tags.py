...
def toggle_enabled(request, toggle_or_toggle_name):
    import commcarehq.toggles
    return _toggle_enabled(commcarehq.toggles, request, toggle_or_toggle_name)


@register.filter
def feature_preview_enabled(request, toggle_name):
    import commcarehq.feature_previews
    return _toggle_enabled(commcarehq.feature_previews, request, toggle_name)
