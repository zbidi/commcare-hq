...
from commcarehq import toggles, privileges, Domain
from commcarehq.apps.accounting.dispatcher import AccountingAdminInterfaceDispatcher
from commcarehq.apps.accounting.models import BillingAccountAdmin, Invoice
from commcarehq.apps.accounting.utils import is_accounting_admin
from commcarehq.apps.domain.utils import get_adm_enabled_domains
from commcarehq.apps.hqadmin.reports import (
    RealProjectSpacesReport,
    CommConnectProjectSpacesReport,
    CommTrackProjectSpacesReport,
)
from commcarehq.apps.hqwebapp.templatetags.hq_shared_tags import toggle_enabled
from commcarehq.apps.hqwebapp.utils import (
    dropdown_dict,
    sidebar_to_dropdown
)
from commcarehq.apps.indicators.dispatcher import IndicatorAdminInterfaceDispatcher
from commcarehq.apps.indicators.utils import get_indicator_domains
from commcarehq.apps.reminders.util import can_use_survey_reminders
from commcarehq.apps.smsbillables.dispatcher import SMSAdminInterfaceDispatcher
...
from commcarehq.apps.reports.models import ReportConfig
from commcarehq.apps.adm.dispatcher import (ADMAdminInterfaceDispatcher,
                                        ADMSectionDispatcher)
from commcarehq.apps.announcements.dispatcher import (
...
class ProjectReportsTab(UITab):
    ...
    view = "commcarehq.apps.reports.views.default"
...
class ADMReportsTab(UITab):
    ...
    view = "commcarehq.apps.adm.views.default_adm_report"
...
class IndicatorAdminTab(UITab):
    ...
    view = "commcarehq.apps.indicators.views.default_admin"
    ...
    def sidebar_items(self):
        ...
        from commcarehq.apps.indicators.views import (
...
class DashboardTab(UITab):
    ...
    view = 'commcarehq.apps.dashboard.views.dashboard_default'
...
class ReportsTab(UITab):
    ...
    def get_view(domain):
        ...
        if hasattr(module, 'DEFAULT_REPORT_CLASS'):
            return "commcarehq.apps.reports.views.default"
        return "commcarehq.apps.reports.views.saved_reports"
...
class ProjectInfoTab(UITab):
    ...
    view = "commcarehq.apps.appstore.views.project_info"
...
class SetupTab(UITab):
    ...
    view = "commcarehq.apps.commtrack.views.default"
    ...
    def dropdown_items(self):
        ...
        from commcarehq.apps.programs.views import ProgramListView
        from commcarehq.apps.products.views import ProductListView
    ...
    def sidebar_items(self):
        ...
        from commcarehq.apps.programs.views import (
            ProgramListView,
            NewProgramView,
            EditProgramView,
        )
        from commcarehq.apps.products.views import (
            ProductListView,
            NewProductView,
            EditProductView,
            ProductFieldsView,
        )
        from commcarehq.apps.locations.views import FacilitySyncView
...
class ProjectDataTab(UITab):
    ...
    view = "commcarehq.apps.data_interfaces.views.default"
    ...
    def sidebar_items(self):
        ...
        if self.can_export_data:
            from commcarehq.apps.data_interfaces.dispatcher \
        ...
        if self.can_edit_commcare_data:
            ...
            from commcarehq.apps.data_interfaces.views \
...
class ApplicationsTab(UITab):
    view = "commcarehq.apps.app_manager.views.default"
...
class CloudcareTab(UITab):
    ...
    view = "commcarehq.apps.cloudcare.views.default"
...
class MessagingTab(UITab):
    ...
    view = "commcarehq.apps.sms.views.default"
    ...
    @property
    def sidebar_items(self):
        from commcarehq.apps.reports.standard.sms import MessageLogReport
        ...
        if self.can_access_reminders:
            from commcarehq.apps.reminders.views import (
        ...
        if self.project.commtrack_enabled:
            from commcarehq.apps.sms.views import SubscribeSMSView
            items.append(
                (_("CommTrack"), [
        ...
        settings_pages = []
        if self.can_access_sms:
            from commcarehq.apps.sms.views import (
...
class ProjectUsersTab(UITab):
    ...
    def sidebar_items(self):
        ...
        if self.couch_user.can_edit_commcare_users():
            ...
            from commcarehq.apps.users.views.mobile import \
        ...
        if self.couch_user.can_edit_web_users():
            ...
            from commcarehq.apps.users.views import (
                EditWebUserView,
            ...
            if self.project.locations_enabled:
                from commcarehq.apps.locations.views import (
                    LocationsListView,
                    NewLocationView,
                    EditLocationView,
                    LocationImportView,
...
class ProjectSettingsTab(UITab):
    ...
    @property
    def sidebar_items(self):
        from commcarehq.apps.domain.views import (FeatureFlagsView,
                                              FeaturePreviewsView,
                                              TransferDomainView)
        ...
        if user_is_admin:
            from commcarehq.apps.domain.views import EditBasicProjectInfoView,\
        ...
        from commcarehq.apps.domain.views import EditMyProjectSettingsView
        project_info.append({
        ...
        if toggles.DHIS2_DOMAIN.enabled(self.domain):
            from commcarehq.apps.domain.views import EditDhis2SettingsView
            project_info.append({
        ...
        if can_view_orgs:
            from commcarehq.apps.domain.views import OrgSettingsView
            project_info.append({
        ...
        if isinstance(self.couch_user, WebUser):
            ...
            if user_is_billing_admin or self.couch_user.is_superuser:
                from commcarehq.apps.domain.views import (
        ...
        if self.couch_user.is_superuser:
            from commcarehq.apps.domain.views import EditInternalDomainInfoView, \
...
class MySettingsTab(UITab):
    ...
    @property
    def sidebar_items(self):
        from commcarehq.apps.settings.views import MyAccountSettingsView, \
...
class AdminReportsTab(UITab):
    ...
    view = "commcarehq.apps.hqadmin.views.default"
...
class GlobalADMConfigTab(UITab):
    ...
    view = "commcarehq.apps.adm.views.default_adm_admin"
...
class AccountingTab(UITab):
    ...
    def sidebar_items(self):
        ...
        from commcarehq.apps.accounting.views import ManageAccountingAdminsView
        ...
        from commcarehq.apps.accounting.views import (
...
class AnnouncementsTab(UITab):
    ...
    view = "commcarehq.apps.announcements.views.default_announcement"
...
class ExchangeTab(UITab):
    ...
    view = "commcarehq.apps.appstore.views.appstore"
...
class OrgReportTab(OrgTab):
    title = ugettext_noop("Reports")
    view = "commcarehq.apps.orgs.views.base_report"
...
class OrgSettingsTab(OrgTab):
    ...
    view = "commcarehq.apps.orgs.views.orgs_landing"
