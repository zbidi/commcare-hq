...
from commcarehq.apps.accounting.models import Subscription
from commcarehq.apps.announcements.models import Notification
from commcarehq.apps.domain.decorators import require_superuser, login_and_domain_required
from commcarehq.apps.domain.utils import normalize_domain_name, get_domain_from_url
from commcarehq.apps.hqwebapp.encoders import LazyEncoder
from commcarehq.apps.hqwebapp.forms import EmailAuthenticationForm, CloudCareAuthenticationForm
from commcarehq.apps.receiverwrapper.models import Repeater
from commcarehq.apps.reports.util import is_mobile_worker_with_report_access
from commcarehq.apps.users.models import CouchUser
from commcarehq.apps.users.util import format_username
from commcarehq.apps.hqwebapp.doc_info import get_doc_info
...
def redirect_to_default(req, domain=None):
    if not req.user.is_authenticated():
        if domain != None:
            ...
            url = reverse('commcarehq.apps.hqwebapp.views.landing_page')
    else:
        if domain:
...
def login(req, domain_type='commcare'):
    ...
    from commcarehq.apps.domain.utils import get_dummy_domain
