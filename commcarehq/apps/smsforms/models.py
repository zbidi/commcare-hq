...
class XFormsSession(Document):
    ...
    workflow = StringProperty() # One of the commcarehq.apps.sms.models.WORKFLOW_* constants describing what kind of workflow this session was a part of
    reminder_id = StringProperty() # Points to the _id of an instance of commcarehq.apps.reminders.models.CaseReminder that this session is tied to
