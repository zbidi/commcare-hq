...
from commcarehq.apps.style.decorators import check_preview_bootstrap3, use_select2
...
from commcarehq import MySettingsTab
from commcarehq.apps.domain.decorators import (login_and_domain_required, require_superuser,
                                           login_required)
...
import commcarehq.apps.style.utils as style_utils
...
class MyAccountSettingsView(BaseMyAccountView):
    ...
    def settings_form(self):
        ...
        from commcarehq.apps.users.forms import UpdateMyAccountInfoForm
