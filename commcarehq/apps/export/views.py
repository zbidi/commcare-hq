...
from commcarehq.apps.export.exceptions import ExportNotFound, ExportAppException
from commcarehq.apps.reports.display import xmlns_to_name
from commcarehq.apps.reports.standard.export import ExcelExportReport, CaseExportReport
from commcarehq.apps.settings.views import BaseProjectDataView
...
require_form_export_permission = require_permission(
    ...
    'commcarehq.apps.reports.standard.export.ExcelExportReport',
