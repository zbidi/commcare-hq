...
from commcarehq.apps.users.forms import RoleForm, SupplyPointSelectWidget
import re
from commcarehq.apps.domain.forms import clean_password, max_pwd
from django.core.validators import validate_email
from commcarehq.apps.domain.models import Domain
from commcarehq.apps.domain.utils import new_domain_re, new_org_re, website_re
