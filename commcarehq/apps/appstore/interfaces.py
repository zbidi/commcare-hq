...
from commcarehq.apps.appstore.dispatcher import AppstoreDispatcher
...
from commcarehq.apps.reports.generic import GenericReportView, GenericTabularReport
...
class CommCareExchangeAdvanced(GenericTabularReport, AppstoreInterface, DatespanMixin):
    name = "Exchange"
    slug = "advanced"
    fields = ['commcarehq.apps.reports.filters.select.SelectOrganizationFilter',
              'commcarehq.apps.reports.filters.select.SelectLicenseFilter',
              'commcarehq.apps.reports.filters.select.SelectCategoryFilter',
              'commcarehq.apps.reports.filters.select.SelectRegionFilter']
