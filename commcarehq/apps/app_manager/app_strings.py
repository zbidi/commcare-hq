...
from commcarehq.apps.app_manager.templatetags.xforms_extras import clean_trans
...
class AppStringsBase(object):
    ...
    def create_default_app_strings(self, app):
        ...
        from commcarehq.apps.app_manager.models import AUTO_SELECT_CASE, AUTO_SELECT_FIXTURE, AUTO_SELECT_USER
