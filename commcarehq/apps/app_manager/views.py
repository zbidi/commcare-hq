...
from commcarehq import ApplicationsTab, toggles, privileges, feature_previews
from commcarehq.apps.accounting.utils import domain_has_privilege
from commcarehq.apps.app_manager import commcare_settings
from commcarehq.apps.app_manager.exceptions import (
    AppEditingError,
    AppManagerException,
    BlankXFormError,
...
from commcarehq.apps.app_manager.forms import CopyApplicationForm
from commcarehq.apps.app_manager import id_strings
from commcarehq.apps.app_manager.templatetags.xforms_extras import trans
from commcarehq.apps.app_manager.translations import (
    expected_bulk_app_sheet_headers,
    process_bulk_app_translation_upload,
    expected_bulk_app_sheet_rows)
from commcarehq.apps.app_manager.view_helpers import ApplicationViewMixin
from commcarehq.apps.hqwebapp.views import BasePageView
from commcarehq.apps.programs.models import Program
from commcarehq.apps.hqmedia.controller import (
    MultimediaImageUploadController,
    MultimediaAudioUploadController,
)
from commcarehq.apps.hqmedia.models import (
    ApplicationMediaReference,
    CommCareImage,
)
from commcarehq.apps.hqmedia.views import (
...
from commcarehq.apps.hqwebapp.utils import get_bulk_upload_form
from commcarehq.apps.reports.formdetails.readable import (
    FormQuestionResponse,
    questions_in_hierarchy,
)
from commcarehq.apps.sms.views import get_sms_autocomplete_context
...
from commcarehq.apps.translations import system_text_sources
from commcarehq.apps.translations.models import Translation
from commcarehq.util.view_utils import set_file_download
from dimagi.utils.django.cached_object import CachedObject
from django.utils.http import urlencode
from django.views.decorators.http import require_GET
from django.conf import settings
from couchdbkit.resource import ResourceNotFound
from commcarehq.apps.app_manager import app_strings
from commcarehq.apps.app_manager.const import (
    APP_V1,
    APP_V2,
    CAREPLAN_GOAL,
    CAREPLAN_TASK,
...
from commcarehq.apps.app_manager.success_message import SuccessMessage
from commcarehq.apps.app_manager.util import is_valid_case_type, get_all_case_properties, add_odk_profile_after_build, ParentCasePropertyBuilder, commtrack_ledger_sections
from commcarehq.apps.app_manager.util import save_xform, get_settings_values
from commcarehq.apps.domain.models import Domain
from commcarehq.apps.domain.views import LoginAndDomainMixin
from commcarehq.util.compression import decompress
...
from commcarehq.apps.app_manager.xform import (
    CaseError,
    XForm,
    XFormException,
    XFormValidationError,
    VELLUM_TYPES)
from commcarehq.apps.builds.models import CommCareBuildConfig, BuildSpec
...
from commcarehq.apps.domain.decorators import login_and_domain_required, login_or_digest
from commcarehq.apps.fixtures.models import FixtureDataType
...
from commcarehq.apps.app_manager.models import import_app as import_app_util, SortElement
from dimagi.utils.web import get_url_base
from commcarehq.apps.app_manager.decorators import safe_download, no_conflict_require_POST, \
...
import importlib
FilterMigration = importlib.import_module('commcarehq.apps.app_manager.migrations.0002_add_filter_to_Detail').Migration
...
def back_to_main(req, domain, app_id=None, module_id=None, form_id=None,
    ...
    return HttpResponseRedirect("%s%s" % (
        reverse('commcarehq.apps.app_manager.views.%s' % view_name, args=args),
...
def _clear_app_cache(request, domain):
    from commcarehq import ApplicationsTab
...
def release_build(request, domain, app_id, saved_app_id):
    ...
    from commcarehq.apps.app_manager.signals import app_post_release
...
def view_generic(req, domain, app_id=None, module_id=None, form_id=None, is_user_registration=False, copy_app_form=None):
    ...
    if app and app.copy_of:
        # don't fail hard.
        return HttpResponseRedirect(reverse("commcarehq.apps.app_manager.views.view_app", args=[domain,app.copy_of]))
    ...
    if app and app.doc_type == 'Application' and has_privilege(req, privileges.COMMCARE_LOGO_UPLOADER):
        ...
        from commcarehq.apps.hqmedia.controller import MultimediaLogoUploadController
        from commcarehq.apps.hqmedia.views import ProcessLogoFileUploadView
        context.update({
...
def _new_careplan_module(req, domain, app, name, lang):
    from commcarehq.apps.app_manager.util import new_careplan_module
...
def download_file(req, domain, app_id, path):
    ...
    def resolve_path(path):
        return RegexURLResolver(
            r'^', 'commcarehq.apps.app_manager.download_urls').resolve(path)
...
def odk_install(req, domain, app_id, with_media=False):
    ...
    context = {
        "domain": domain,
        "app": app,
        "qr_code": reverse("commcarehq.apps.app_manager.views.%s" % qr_code_view, args=[domain, app_id]),
