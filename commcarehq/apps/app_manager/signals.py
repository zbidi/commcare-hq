...
from commcarehq.apps.app_manager.const import CAREPLAN_GOAL, CAREPLAN_TASK
...
from commcarehq.middleware import OPENROSA_ACCEPT_LANGUAGE
from commcarehq.apps.app_manager.models import Application, get_app, CareplanModule, CareplanConfig, CareplanAppProperties
...
def create_app_structure_repeat_records(sender, application, **kwargs):
    from commcarehq.apps.receiverwrapper.models import AppStructureRepeater
