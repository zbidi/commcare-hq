...
from commcarehq.apps.app_manager.exceptions import CaseError
from commcarehq.apps.app_manager.models import AppEditingError, get_app
...
def safe_download(f):
    ...
    def _safe_download(req, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseRedirect(reverse("commcarehq.apps.app_manager.views.view_app", args=[domain,app_id]))
