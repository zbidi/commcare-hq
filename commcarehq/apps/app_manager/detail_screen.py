...
from commcarehq.apps.app_manager import suite_xml as sx
from commcarehq.apps.app_manager.util import is_sort_only_column
from commcarehq.apps.app_manager.xpath import (
    CaseXPath,
    CommCareSession,
    IndicatorXpath,
    LedgerdbXpath,
...
CASE_PROPERTY_MAP = {
    ...
    # (commcarehq/apps/cloudcare/static/cloudcare/js/backbone/cases.js)
