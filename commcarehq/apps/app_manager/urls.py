...
from commcarehq.apps.app_manager.view_helpers import DynamicTemplateView
from commcarehq.apps.app_manager.views import DownloadCCZ, AppSummaryView
from commcarehq.apps.hqmedia.urls import application_urls as hqmedia_urls

app_urls = patterns('commcarehq.apps.app_manager.views',
...
urlpatterns = patterns('commcarehq.apps.app_manager.views',
    ...
    url(r'^download/(?P<app_id>[\w-]+)/',
        include('commcarehq.apps.app_manager.download_urls')),
