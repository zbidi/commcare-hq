...
from commcarehq.apps.app_manager.const import APP_V1, SCHEDULE_PHASE, SCHEDULE_LAST_VISIT, SCHEDULE_LAST_VISIT_DATE, \
    CASE_ID
from lxml import etree as ET
from commcarehq.util.view_utils import get_request
...
#                        raise Exception("Invalid XPath Expression %s" % xpath)
    ...
    def create_casexml_2(self, form):
        from commcarehq.apps.app_manager.util import split_path
