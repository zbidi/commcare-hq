...
from commcarehq.apps.app_manager.const import CT_REQUISITION_MODE_3, CT_LEDGER_STOCK, CT_LEDGER_REQUESTED, CT_REQUISITION_MODE_4, CT_LEDGER_APPROVED, CT_LEDGER_PREFIX
from commcarehq.apps.app_manager.xform import XForm, XFormException, parse_xml
import re
...
class ParentCasePropertyBuilder(object):
    ...
    def get_other_case_sharing_apps_in_domain(self):
        from commcarehq.apps.app_manager.models import get_apps_in_domain
...
def create_temp_sort_column(field, index):
    ...
    """
    from commcarehq.apps.app_manager.models import SortOnlyDetailColumn
...
def new_careplan_module(app, name, lang, target_module):
    from commcarehq.apps.app_manager.models import CareplanModule, CareplanGoalForm, CareplanTaskForm
