...
from commcarehq.apps.receiverwrapper.exceptions import DuplicateFormatException, IgnoreDocument
from commcarehq.apps.receiverwrapper.models import (
    CaseRepeater,
    FormRepeater,
    RepeatRecord,
    RegisterGenerator)
from commcarehq.apps.receiverwrapper.repeater_generators import BasePayloadGenerator
...
class RepeaterTest(BaseRepeaterTest):
    ...
    def test_repeater(self):
        ...
        #   - commcarehq.apps.receiverwrapper.signals
