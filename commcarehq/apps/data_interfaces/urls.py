...
from commcarehq.apps.data_interfaces.views import CaseGroupListView, CaseGroupCaseManagementView, ArchiveFormView

edit_data_urls = patterns(
    'commcarehq.apps.data_interfaces.views',
...
urlpatterns = patterns(
    ...
    (r'^export/', include('commcarehq.apps.export.urls')),
