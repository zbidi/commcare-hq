...
from commcarehq.apps.domain.decorators import login_and_domain_required, cls_to_view
...
class ReportDispatcher(View):
    ...
    def get_reports(self, domain=None):
        ...
        commcarehq_reports = process(getattr(commcarehq, attr_name, ()))
        custom_reports = process(getattr(domain_module, attr_name, ()))

        return commcarehq_reports + custom_reports
