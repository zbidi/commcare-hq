...
from commcarehq.apps.api.resources import HqBaseResource
...
from commcarehq.apps.reports.commtrack.data_sources import StockStatusDataSource
...
class ReportResource(HqBaseResource):
    ...
    def get_api_sources(self, request, domain=None):
        # TODO: implement method. See commcarehq.apps.reports.dispatcher.ReportDispatcher#get_reports
        return []
