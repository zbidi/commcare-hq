...
from commcarehq.apps.announcements.models import ReportAnnouncement
from commcarehq.apps.groups.models import Group
from commcarehq.apps.reports.display import xmlns_to_name
from commcarehq.apps.reports.models import HQUserType, TempCommCareUser
from commcarehq.apps.users.models import CommCareUser, CouchUser
from commcarehq.apps.users.util import user_id_to_username
...
def get_possible_reports(domain_name):
    from commcarehq.apps.reports.dispatcher import (ProjectReportDispatcher, CustomProjectReportDispatcher)
