...
import operator
import pytz
from commcarehq.apps.es import filters
from commcarehq.apps.es.cases import CaseES
from commcarehq.apps.es.forms import FormES
from commcarehq.apps.reports import util
from commcarehq.apps.reports.filters.users import ExpandedMobileWorkerFilter as EMWF
from commcarehq.apps.reports.standard import ProjectReportParametersMixin, \
    DatespanMixin, ProjectReport, DATE_FORMAT
from commcarehq.apps.reports.filters.forms import CompletionOrSubmissionTimeFilter, FormsByApplicationFilter, SingleFormByApplicationFilter, MISSING_APP_ID
from commcarehq.apps.reports.datatables import DataTablesHeader, DataTablesColumn, DTSortType, DataTablesColumnGroup
from commcarehq.apps.reports.generic import GenericTabularReport
from commcarehq.apps.reports.util import make_form_couch_key, friendly_timedelta, format_datatables_data
from commcarehq.apps.sofabed.models import FormData, CaseData
...
class CaseActivityReport(WorkerMonitoringReportTableBase):
    ...
    slug = 'case_activity'
    fields = ['commcarehq.apps.reports.filters.users.ExpandedMobileWorkerFilter',
              'commcarehq.apps.reports.filters.select.CaseTypeFilter']
    all_users = None
...
class SubmissionsByFormReport(WorkerMonitoringReportTableBase,
    ...
    fields = [
        'commcarehq.apps.reports.filters.users.ExpandedMobileWorkerFilter',
        'commcarehq.apps.reports.filters.forms.FormsByApplicationFilter',
...
class DailyFormStatsReport(WorkerMonitoringReportTableBase, CompletionOrSubmissionTimeMixin, DatespanMixin):
    ...
    fields = [
        'commcarehq.apps.reports.filters.users.ExpandedMobileWorkerFilter',
        'commcarehq.apps.reports.filters.forms.CompletionOrSubmissionTimeFilter',
        'commcarehq.apps.reports.filters.dates.DatespanFilter',
    ]
...
class FormCompletionTimeReport(WorkerMonitoringReportTableBase, DatespanMixin,
    ...
    fields = ['commcarehq.apps.reports.filters.users.ExpandedMobileWorkerFilter',
              'commcarehq.apps.reports.filters.forms.SingleFormByApplicationFilter',
              'commcarehq.apps.reports.filters.forms.CompletionOrSubmissionTimeFilter',
              'commcarehq.apps.reports.filters.dates.DatespanFilter']
    ...
    def get_user_link(self, user):
        ...
        from commcarehq.apps.reports.standard.inspect import SubmitHistory
...
class WorkerActivityReport(WorkerMonitoringReportTableBase, DatespanMixin):
    ...
    fields = [
        'commcarehq.apps.reports.dont_use.fields.MultiSelectGroupField',
        'commcarehq.apps.reports.dont_use.fields.UserOrGroupField',
        'commcarehq.apps.reports.filters.select.MultiCaseTypeFilter',
        'commcarehq.apps.reports.filters.dates.DatespanFilter',
    ]
    fix_left_col = True
    emailable = True
