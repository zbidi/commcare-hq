...
from commcarehq.apps.reports.standard import DatespanMixin, ProjectReport,\
...
from commcarehq.apps.reports.datatables import DataTablesColumn, DataTablesHeader,\
    DTSortType
from commcarehq.apps.sms.filters import MessageTypeFilter
...
import pytz
from commcarehq.apps.users.views import EditWebUserView
...
class MessagesReport(ProjectReport, ProjectReportParametersMixin, GenericTabularReport, DatespanMixin):
    ...
    slug = 'messages'
    fields = ['commcarehq.apps.reports.filters.select.GroupFilter',
...
class MessageLogReport(BaseCommConnectLogReport):
    ...
    fields = [
        'commcarehq.apps.reports.filters.dates.DatespanFilter',
        'commcarehq.apps.sms.filters.MessageTypeFilter',
    ]
    exportable = True
