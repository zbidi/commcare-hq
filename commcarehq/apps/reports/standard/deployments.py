...
from commcarehq.apps.receiverwrapper.util import get_meta_appversion_text, get_build_version, \
    BuildVersionSource
from couchdbkit import ResourceNotFound
from commcarehq.apps.app_manager.models import get_app
from commcarehq.apps.reports.filters.select import SelectApplicationFilter
from commcarehq.apps.reports.standard import ProjectReportParametersMixin, ProjectReport
from commcarehq.apps.reports.datatables import DataTablesHeader, DataTablesColumn, DTSortType
from commcarehq.apps.reports.generic import GenericTabularReport
from commcarehq.apps.reports.util import make_form_couch_key, format_datatables_data
from commcarehq.apps.users.models import CommCareUser
from commcarehq.toggles import VIEW_SYNC_HISTORY
...
class ApplicationStatusReport(DeploymentsReport):
    ...
    fields = ['commcarehq.apps.reports.filters.users.UserTypeFilter',
              ...
              'commcarehq.apps.reports.filters.select.SelectApplicationFilter']
...
class SyncHistoryReport(DeploymentsReport):
    ...
    slug = "sync_history"
    fields = ['commcarehq.apps.reports.filters.users.SelectMobileWorkerFilter']
