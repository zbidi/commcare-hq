...
from commcarehq.apps.data_interfaces.interfaces import DataInterface
from commcarehq.apps.reports.standard import ProjectReportParametersMixin, DatespanMixin
from commcarehq.apps.reports.models import FormExportSchema, HQGroupExportConfiguration
from commcarehq.apps.reports.util import datespan_from_beginning
from couchexport.models import SavedExportSchema, Format
from commcarehq.apps.app_manager.models import get_app, Application
...
class FormExportReportBase(ExportReport, DatespanMixin):
    ...
    def get_subpages(self):
        from commcarehq.apps.export.views import CreateCustomFormExportView, EditCustomFormExportView
        return [
            {
...
class CaseExportReport(ExportReport):
    ...
    @classmethod
    def get_subpages(self):
        from commcarehq.apps.export.views import CreateCustomCaseExportView, EditCustomCaseExportView
        return [
            {
