...
from commcarehq.apps.es import users as user_es
from commcarehq.apps.es.es_query import HQESQuery
...
from commcarehq.apps.reports.filters.users import ExpandedMobileWorkerFilterWithAllData as EMWF
...
from commcarehq.apps.reports.standard.inspect import ProjectInspectionReport
...
class CaseListMixin(ElasticProjectInspectionReport, ProjectReportParametersMixin):
    fields = [
        'commcarehq.apps.reports.filters.users.ExpandedMobileWorkerFilterWithAllData',
    ...
    def location_reporting_owner_ids(self):
        ...
        """
        from commcarehq.apps.locations.models import SQLLocation, LOCATION_REPORTING_PREFIX
