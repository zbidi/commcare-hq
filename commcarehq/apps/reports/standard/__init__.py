...
from commcarehq.apps.reports.exceptions import BadRequestError
...
class ProjectReportParametersMixin(object):
    ...
    def users_by_mobile_workers(self):
        from commcarehq.apps.reports.util import _report_user_dict
        user_dict = {}
...
class DatespanMixin(object):
    ...
    """
    datespan_field = 'commcarehq.apps.reports.filters.dates.DatespanFilter'
