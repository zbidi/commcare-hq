...
from commcarehq import feature_previews
...
from commcarehq.apps.reports.display import xmlns_to_name
from commcarehq.apps.reports.dont_use.fields import StrongFilterUsersField
from commcarehq.apps.reports.filters.forms import MISSING_APP_ID, FormsByApplicationFilter
from commcarehq.apps.reports.generic import GenericTabularReport, ProjectInspectionReportParamsMixin, ElasticProjectInspectionReport
from commcarehq.apps.reports.standard.monitoring import MultiFormDrilldownMixin, CompletionOrSubmissionTimeMixin
from commcarehq.apps.reports.util import datespan_from_beginning
from commcarehq.apps.users.models import CouchUser
from commcarehq.elastic import es_query, ADD_TO_ES_FILTER
...
from commcarehq import elastic
    ...
    def __init__(self, request, **kwargs):
        if feature_previews.SUBMIT_HISTORY_FILTERS.enabled(request.domain):
            ...
            self.fields = self.fields + [
                'commcarehq.apps.reports.filters.forms.FormDataFilter',
                'commcarehq.apps.reports.filters.forms.CustomFieldFilter',
            ]
