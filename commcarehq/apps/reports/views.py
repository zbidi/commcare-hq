...
from commcarehq import toggles, Domain
from casexml.apps.case.cleanup import rebuild_case, close_case
from commcarehq.apps.products.models import SQLProduct
from commcarehq.apps.data_interfaces.dispatcher import DataInterfaceDispatcher
from commcarehq.apps.reports.display import FormType
from commcarehq.util.couch import get_document_or_404
from commcarehq.util.view_utils import absolute_reverse
...
from commcarehq.apps.export.exceptions import BadExportConfiguration
from commcarehq.apps.hqwebapp.models import ReportsTab
from commcarehq.apps.reports.exportfilters import default_form_filter
import couchforms.views as couchforms_views
from couchforms.filters import instances
from couchforms.models import XFormInstance, doc_types
from commcarehq.apps.reports.templatetags.xform_tags import render_form
from filters.users import UserTypeFilter
from commcarehq.apps.domain.decorators import (login_or_digest)
from commcarehq.apps.export.custom_export_helpers import CustomExportHelper
from commcarehq.apps.groups.models import Group
from commcarehq.apps.hqcase.export import export_cases_and_referrals
from commcarehq.apps.reports.dispatcher import ProjectReportDispatcher
from commcarehq.apps.reports.models import (
    ReportConfig,
    ReportNotification,
...
from commcarehq.apps.reports.tasks import create_metadata_export, rebuild_export_async
from commcarehq.apps.reports import util
from commcarehq.apps.reports.util import (
    get_all_users_by_domain,
    users_matching_filter,
)
from commcarehq.apps.reports.standard import inspect, export, ProjectReport
from commcarehq.apps.reports.export import (ApplicationBulkExportHelper,
    CustomBulkExportHelper, save_metadata_export_to_tempfile)
from commcarehq.apps.users.decorators import require_permission
from commcarehq.apps.users.export import export_users
...
require_form_export_permission = require_permission(Permissions.view_report, 'commcarehq.apps.reports.standard.export.ExcelExportReport', login_decorator=None)
require_case_export_permission = require_permission(Permissions.view_report, 'commcarehq.apps.reports.standard.export.CaseExportReport', login_decorator=None)

require_form_view_permission = require_permission(Permissions.view_report, 'commcarehq.apps.reports.standard.inspect.SubmitHistory', login_decorator=None)
require_case_view_permission = require_permission(Permissions.view_report, 'commcarehq.apps.reports.standard.cases.basic.CaseListReport', login_decorator=None)
...
def can_view_attachments(request):
    return (
        request.couch_user.has_permission(
            ...
            data='commcarehq.apps.reports.standard.cases.basic.CaseListReport'
        )
...
@require_permission('view_report', 'commcarehq.apps.reports.standard.export.DeidExportReport', login_decorator=None)
...
def edit_scheduled_report(request, domain, scheduled_report_id=None,
    ...
    from commcarehq.apps.reports.forms import ScheduledReportForm
...
def send_test_scheduled_report(request, domain, scheduled_report_id):
    from commcarehq.apps.reports.tasks import send_report
