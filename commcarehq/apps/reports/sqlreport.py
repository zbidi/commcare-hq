...
from commcarehq.apps.reports.basic import GenericTabularReport
    ...
    def __init__(self, header, agg_column, format_fn=None, slug=None, *args, **kwargs):
        ...
        Kwargs:
            :param header_group=None:
                An instance of commcarehq.apps.reports.datatables.DataTablesColumnGroup to which this column header will
                be added.
            :param sortable:
            ...
            :param sort_type:
                See commcarehq.apps.reports.datatables.DTSortType
            :param format_fn=None:
                Function to apply to value before display. Useful for formatting and sorting.
                See commcarehq.apps.reports.util.format_datatables_data
            :param slug=None:
