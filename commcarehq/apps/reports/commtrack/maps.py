...
class StockStatusMapReport(GenericMapReport, CommtrackReportMixin):
    ...
    data_source = {
        'adapter': 'report',
        'geo_column': 'geo',
        'report': 'commcarehq.apps.reports.commtrack.data_sources.StockStatusBySupplyPointDataSource',
    }
...
class ReportingStatusMapReport(GenericMapReport, CommtrackReportMixin):
    ...
    data_source = {
        'adapter': 'report',
        'geo_column': 'geo',
        'report': 'commcarehq.apps.reports.commtrack.data_sources.ReportingStatusDataSource',
    }
