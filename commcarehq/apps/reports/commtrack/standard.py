...
from commcarehq.apps.reports.commtrack.data_sources import StockStatusDataSource, ReportingStatusDataSource, SimplifiedInventoryDataSource
...
from commcarehq.apps.commtrack.models import CommtrackConfig, CommtrackActionConfig, StockState
from commcarehq.apps.products.models import Product, SQLProduct
from commcarehq.apps.reports.graph_models import PieChart, MultiBarChart, Axis
from commcarehq.apps.reports.standard import ProjectReport, ProjectReportParametersMixin, DatespanMixin
from commcarehq.apps.reports.filters.commtrack import SelectReportingType
...
from commcarehq.apps.reports.commtrack.util import get_relevant_supply_point_ids, product_ids_filtered_by_program
from commcarehq.apps.reports.commtrack.const import STOCK_SECTION_TYPE
from commcarehq.apps.reports.filters.commtrack import AdvancedColumns
...
class CurrentStockStatusReport(GenericTabularReport, CommtrackReportMixin):
    ...
    fields = [
        ...
        'commcarehq.apps.reports.dont_use.fields.SelectProgramField',
...
class SimplifiedInventoryReport(GenericTabularReport, CommtrackReportMixin):
    ...
    fields = [
        'commcarehq.apps.reports.filters.fixtures.AsyncLocationFilter',
        'commcarehq.apps.reports.dont_use.fields.SelectProgramField',
        'commcarehq.apps.reports.filters.dates.SingleDateFilter',
    ]
...
class InventoryReport(GenericTabularReport, CommtrackReportMixin):
    ...
    fields = [
        ...
        'commcarehq.apps.reports.dont_use.fields.SelectProgramField',
        'commcarehq.apps.reports.filters.dates.DatespanFilter',
        'commcarehq.apps.reports.filters.commtrack.AdvancedColumns',
    ]
    exportable = True
    emailable = True
...
class ReportingRatesReport(GenericTabularReport, CommtrackReportMixin):
    ...
    fields = [
        ...
        'commcarehq.apps.reports.filters.dates.DatespanFilter',
        'commcarehq.apps.reports.filters.commtrack.SelectReportingType',
    ]
    exportable = True
    emailable = True
...
class RequisitionReport(CaseListReport):
    ...
    fields = ['commcarehq.apps.reports.filters.fixtures.AsyncLocationFilter',
