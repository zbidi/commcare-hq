...
from commcarehq.apps.reports.util import get_installed_custom_modules
...
from commcarehq.apps.example_reports.testreport import TestReport
from commcarehq.apps.userreports.reports.view import ConfigurableReport
from commcarehq.apps.userreports.views import (
...
urlpatterns = patterns('commcarehq.apps.reports.views',
    ...
    # Download Exports
    # todo should eventually be moved to commcarehq.apps.export
    # Custom
