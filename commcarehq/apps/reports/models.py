...
from commcarehq.apps import reports
from commcarehq.apps.app_manager.models import get_app, Form, RemoteApp
from commcarehq.apps.app_manager.util import ParentCasePropertyBuilder
from commcarehq.apps.cachehq.mixins import CachedCouchDocumentMixin
from commcarehq.apps.domain.middleware import CCHQPRBACMiddleware
from commcarehq.apps.export.models import FormQuestionSchema
from commcarehq.apps.reports.display import xmlns_to_name
from couchdbkit.ext.django.schema import *
from commcarehq.apps.reports.exportfilters import form_matches_users, is_commconnect_form, default_form_filter, \
    default_case_filter
from commcarehq.apps.users.models import WebUser, CommCareUser, CouchUser
from commcarehq.feature_previews import CALLCENTER
...
from commcarehq.apps.adm.dispatcher import ADMSectionDispatcher
import json
import calendar
...
class ReportNotification(CachedCouchDocumentMixin, Document):
    ...
    def send(self):
        ...
        from commcarehq.apps.reports.views import get_scheduled_report_response
...
class CaseExportSchema(HQExportSchema):
    ...
    def case_properties(self):
        ...
        if CALLCENTER.enabled(self.domain):
            from commcarehq.apps.custom_data_fields.models import CustomDataFieldsDefinition
