...
from commcarehq.apps.userreports.filters.specs import (PropertyMatchFilterSpec, NotFilterSpec, NamedFilterSpec,
    BooleanExpressionFilterSpec)
from commcarehq.apps.userreports.exceptions import BadSpecError
from commcarehq.apps.userreports.filters import ANDFilter, ORFilter, NOTFilter, SinglePropertyValueFilter
from commcarehq.apps.userreports.operators import EQUAL, get_operator
