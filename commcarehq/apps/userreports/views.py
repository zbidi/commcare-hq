...
from commcarehq.apps.app_manager.models import Application, Form
from django.utils.translation import ugettext as _
from django.views.decorators.http import require_POST
from django.views.generic import TemplateView

from commcarehq.apps.reports.dispatcher import cls_to_view_login_and_domain
from commcarehq import ConfigurableReport, privileges, Session, toggles
from commcarehq.apps.domain.decorators import login_and_domain_required, login_or_basic
from commcarehq.apps.userreports.app_manager import get_case_data_source, get_form_data_source
from commcarehq.apps.userreports.exceptions import BadSpecError
from commcarehq.apps.userreports.reports.builder.forms import (
    ConfigureNewBarChartReport,
    ConfigureNewPieChartReport,
    ConfigureNewTableReport,
    CreateNewReportForm,
)
from commcarehq.apps.userreports.models import (
    ReportConfiguration,
    DataSourceConfiguration,
    CustomDataSourceConfiguration,
)
from commcarehq.apps.userreports.sql import get_indicator_table, IndicatorSqlAdapter, get_engine
from commcarehq.apps.userreports.tasks import rebuild_indicators
from commcarehq.apps.userreports.ui.forms import (
