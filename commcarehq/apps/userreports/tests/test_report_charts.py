...
from commcarehq import ReportConfiguration
from commcarehq.apps.userreports.exceptions import BadSpecError
from commcarehq.apps.userreports.reports.factory import ChartFactory
from commcarehq.apps.userreports.reports.specs import PieChartSpec, MultibarChartSpec, MultibarAggregateChartSpec
