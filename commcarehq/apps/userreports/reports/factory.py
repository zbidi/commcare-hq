...
from commcarehq.apps.reports_core.filters import DatespanFilter, ChoiceListFilter, Choice, DynamicChoiceListFilter, \
    NumericFilter
from commcarehq.apps.userreports.exceptions import BadSpecError
from django.utils.translation import ugettext as _
from commcarehq.apps.userreports.reports.filters import(
    dynamic_choice_list_url,
    NONE_CHOICE,
    SHOW_ALL_CHOICE,
)
from commcarehq.apps.userreports.reports.specs import FilterSpec, ChoiceListFilterSpec, PieChartSpec, \
...
class ReportFactory(object):
    ...
    @classmethod
    def from_spec(cls, spec):
        from commcarehq.apps.userreports.reports.data_source import ConfigurableReportDataSource
