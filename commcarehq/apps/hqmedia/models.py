...
from commcarehq.apps.app_manager.exceptions import XFormException
from dimagi.utils.couch.resource_conflict import retry_resource
from django.contrib import messages
from django.core.urlresolvers import reverse
import magic
from commcarehq.apps.app_manager.xform import XFormValidationError
from dimagi.utils.decorators.memoized import memoized
from commcarehq.apps.domain.models import LICENSES, LICENSE_LINKS
...
class HQMediaMixin(Document):
    ...
    def get_media_references(self, request=None):
        ...
        from commcarehq.apps.hqmedia.utils import get_application_media
