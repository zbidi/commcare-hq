...
urlpatterns = patterns('commcarehq.apps.hqmedia.views',
...
application_urls = patterns('commcarehq.apps.hqmedia.views',
...
download_urls = patterns('commcarehq.apps.hqmedia.views',
