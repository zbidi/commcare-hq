...
from commcarehq.apps.adm.models import REPORT_SECTION_OPTIONS, ADMReport
...
from commcarehq.apps.reports.standard import DatespanMixin, ProjectReportParametersMixin
