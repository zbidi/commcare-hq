from commcarehq.apps.accounting.dispatcher import (
    AccountingAdminInterfaceDispatcher
)
from commcarehq.apps.accounting.filters import *
from commcarehq.apps.accounting.forms import AdjustBalanceForm
from commcarehq.apps.accounting.models import (
    BillingAccount, Subscription, SoftwarePlan
)
from commcarehq.apps.accounting.utils import get_money_str, quantize_accounting_decimal
...
class AccountingInterface(AddItemInterface):
    ...
    fields = ['commcarehq.apps.accounting.interface.DateCreatedFilter',
              'commcarehq.apps.accounting.interface.NameFilter',
              'commcarehq.apps.accounting.interface.SalesforceAccountIDFilter',
              'commcarehq.apps.accounting.interface.AccountTypeFilter',
              'commcarehq.apps.accounting.interface.ActiveStatusFilter',
              'commcarehq.apps.accounting.interface.DimagiContactFilter',
              'commcarehq.apps.accounting.interface.EntryPointFilter',
              ]
    hide_filters = False
    ...
    def new_item_view(self):
        from commcarehq.apps.accounting.views import NewBillingAccountView
...
class SubscriptionInterface(AddItemInterface):
    ...
    fields = [
        'commcarehq.apps.accounting.interface.StartDateFilter',
        'commcarehq.apps.accounting.interface.EndDateFilter',
        'commcarehq.apps.accounting.interface.DateCreatedFilter',
        'commcarehq.apps.accounting.interface.SubscriberFilter',
        'commcarehq.apps.accounting.interface.SalesforceContractIDFilter',
        'commcarehq.apps.accounting.interface.ActiveStatusFilter',
        'commcarehq.apps.accounting.interface.DoNotInvoiceFilter',
        'commcarehq.apps.accounting.interface.CreatedSubAdjMethodFilter',
        'commcarehq.apps.accounting.interface.TrialStatusFilter',
        'commcarehq.apps.accounting.interface.SubscriptionTypeFilter',
        'commcarehq.apps.accounting.interface.ProBonoStatusFilter',
    ]
    hide_filters = False
    ...
    @property
    def new_item_view(self):
        from commcarehq.apps.accounting.views import NewSubscriptionViewNoDefaultDomain
    ...
    @property
    def rows(self):
        from commcarehq.apps.accounting.views import ManageBillingAccountView
        rows = []
        filters = {}
...
class SoftwarePlanInterface(AddItemInterface):
    ...
    fields = [
        'commcarehq.apps.accounting.interface.SoftwarePlanNameFilter',
        'commcarehq.apps.accounting.interface.SoftwarePlanEditionFilter',
        'commcarehq.apps.accounting.interface.SoftwarePlanVisibilityFilter',
    ]
    hide_filters = False
    ...
    @property
    def new_item_view(self):
        from commcarehq.apps.accounting.views import NewSoftwarePlanView
...
class InvoiceInterface(GenericTabularReport):
    ...
    fields = [
        'commcarehq.apps.accounting.interface.NameFilter',
        'commcarehq.apps.accounting.interface.SubscriberFilter',
        'commcarehq.apps.accounting.interface.PaymentStatusFilter',
        'commcarehq.apps.accounting.interface.StatementPeriodFilter',
        'commcarehq.apps.accounting.interface.DueDatePeriodFilter',
        'commcarehq.apps.accounting.interface.SalesforceAccountIDFilter',
        'commcarehq.apps.accounting.interface.SalesforceContractIDFilter',
        'commcarehq.apps.accounting.interface.SoftwarePlanNameFilter',
        'commcarehq.apps.accounting.interface.BillingContactFilter',
        'commcarehq.apps.accounting.interface.IsHiddenFilter',
    ]
...
class PaymentRecordInterface(GenericTabularReport):
    ...
    fields = [
        ...
        'commcarehq.apps.accounting.interface.NameFilter',
        'commcarehq.apps.accounting.interface.SubscriberFilter',
        'commcarehq.apps.accounting.interface.PaymentTransactionIdFilter',
    ]
