...
from commcarehq.apps.accounting import utils
from commcarehq.apps.accounting.exceptions import InvoiceError, CreditLineError, BillingContactInfoError
...
from commcarehq.apps.users.models import FakeUser, WebUser
from couchexport.export import export_from_tables
from couchexport.models import Format
from dimagi.utils.couch.database import iter_docs
from dimagi.utils.django.email import send_HTML_email
import commcarehq.apps.accounting.filters as filters
...
def send_bookkeeper_email(month=None, year=None, emails=None):
    ...
    from commcarehq.apps.accounting.interface import InvoiceInterface
    request = HttpRequest()
    params = urlencode((
