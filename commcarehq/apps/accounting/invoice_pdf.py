...
from commcarehq.apps.accounting.exceptions import InvoiceError
from commcarehq.apps.accounting.utils import get_money_str
import settings


LOGO_FILENAME = \
    'commcarehq/apps/accounting/static/accounting/media/Dimagi-Logo-RGB.jpg'
