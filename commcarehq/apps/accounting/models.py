...
from commcarehq.apps.accounting.invoice_pdf import InvoiceTemplate
...
from commcarehq.apps.accounting.subscription_changes import (
...
class SoftwarePlanVersion(models.Model):
    ...
    def user_facing_description(self):
        from commcarehq.apps.accounting.user_text import DESC_BY_EDITION, FEATURE_TYPE_TO_NAME
