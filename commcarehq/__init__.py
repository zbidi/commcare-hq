...
from commcarehq.apps.hqpillow_retry.views import PillowErrorsReport
from commcarehq.apps.reports.standard import (monitoring, inspect, export,
    deployments, sms, ivr)
from commcarehq.apps.receiverwrapper import reports as receiverwrapper
from commcarehq.apps.userreports.models import ReportConfiguration
from commcarehq.apps.userreports.reports.view import ConfigurableReport
import phonelog.reports as phonelog
from commcarehq.apps.reports.commtrack import standard as commtrack_reports
from commcarehq.apps.reports.commtrack import maps as commtrack_maps
from commcarehq.apps.reports.commconnect import system_overview
from commcarehq.apps.fixtures.interface import FixtureViewInterface, FixtureEditInterface
import hashlib
...
def REPORTS(project):
    ...
    from commcarehq.apps.reports.standard.cases.careplan import make_careplan_reports
    from commcarehq.apps.reports.standard.maps import DemoMapReport, DemoMapReport2, DemoMapCaseList
    ...
    if project.has_careplan:
        from commcarehq.apps.app_manager.models import CareplanConfig
...
def _get_configurable_reports(project):
    ...
    if configs:
        def _make_report_class(config):
            from commcarehq.apps.reports.generic import GenericReportView
...
from commcarehq.apps.data_interfaces.interfaces import CaseReassignmentInterface
from commcarehq.apps.importer.base import ImportCases
...
from commcarehq.apps.adm.admin import columns, reports
...
from commcarehq.apps.indicators.admin import document_indicators, couch_indicators, dynamic_indicators
...
from commcarehq.apps.announcements.interface import (
...
from commcarehq.apps.accounting.interface import (
    AccountingInterface,
...
from commcarehq.apps.smsbillables.interface import (
...
from commcarehq.apps.appstore.interfaces import CommCareExchangeAdvanced
...
from commcarehq.apps.reports.standard.domains import OrgDomainStatsReport
...
from commcarehq.apps.hqwebapp.models import *
from commcarehq.apps.styleguide.tabs import SGExampleTab
...
from commcarehq.db import Session
