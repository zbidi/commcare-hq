...
import pytz
from commcarehq.apps.reports.datatables.DTSortType import DATE
from commcarehq.apps.reports.filters.devicelog import (
    DeviceLogDevicesFilter,
    DeviceLogTagFilter,
    DeviceLogUsersFilter,
)
from commcarehq.apps.reports.generic import PaginatedReportMixin, GetParamsMixin
from commcarehq.apps.reports.standard import DatespanMixin
from commcarehq.apps.reports.standard.deployments import DeploymentsReport
...
from commcarehq.apps.reports.util import _report_user_dict, SimplifiedUserInfo
...
class DeviceLogDetailsReport(PhonelogReport):
    ...
    fields = ['commcarehq.apps.reports.filters.dates.DatespanFilter',
              'commcarehq.apps.reports.filters.devicelog.DeviceLogTagFilter',
              'commcarehq.apps.reports.filters.devicelog.DeviceLogUsersFilter',
              'commcarehq.apps.reports.filters.devicelog.DeviceLogDevicesFilter']
    tag_labels = {
