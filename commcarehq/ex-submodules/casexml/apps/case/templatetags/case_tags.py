...
def render_case(case, options):
    ...
    """
    from commcarehq.apps.hqwebapp.templatetags.proptable_tags import get_tables_as_rows, get_definition
...
def render_case_hierarchy(case, options):
    ...
    from commcarehq.apps.hqwebapp.templatetags.proptable_tags import get_display_data
