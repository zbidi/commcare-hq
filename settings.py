...
MIDDLEWARE_CLASSES = [
    ...
    'commcarehq.middleware.OpenRosaMiddleware',
    'commcarehq.apps.users.middleware.UsersMiddleware',
    'commcarehq.apps.domain.middleware.CCHQPRBACMiddleware',
...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    "commcarehq.util.context_processors.current_url_name",
    'commcarehq.util.context_processors.domain',
    # sticks the base template inside all responses
    "commcarehq.util.context_processors.base_template",
    "commcarehq.util.context_processors.analytics_js",
    "commcarehq.util.context_processors.raven",
]

TEMPLATE_DIRS = []

DEFAULT_APPS = (
    'commcarehq.apps.userhack',  # this has to be above auth
...
HQ_APPS = (
    ...
    'casexml.apps.phone',
    'casexml.apps.stock',
    'commcarehq.apps.cleanup',
    'commcarehq.apps.cloudcare',
    'commcarehq.apps.smsbillables',
    'commcarehq.apps.accounting',
    'commcarehq.apps.appstore',
    'commcarehq.apps.domain',
    'commcarehq.apps.domainsync',
    'commcarehq.apps.hqadmin',
    'commcarehq.apps.hqcase',
    'commcarehq.apps.hqcouchlog',
    'commcarehq.apps.hqwebapp',
    'commcarehq.apps.hqmedia',
    'commcarehq.apps.loadtestendpoints',
    'commcarehq.apps.locations',
    'commcarehq.apps.products',
    'commcarehq.apps.programs',
    'commcarehq.apps.commtrack',
    'commcarehq.apps.consumption',
    'couchforms',
    'couchexport',
    'couchlog',
    'ctable',
    ...
    'langcodes',
    'commcarehq.apps.adm',
    'commcarehq.apps.announcements',
    'commcarehq.apps.callcenter',
    'commcarehq.apps.crud',
    'commcarehq.apps.custom_data_fields',
    'commcarehq.apps.receiverwrapper',
    'commcarehq.apps.app_manager',
    'commcarehq.apps.es',
    'commcarehq.apps.facilities',
    'commcarehq.apps.fixtures',
    'commcarehq.apps.importer',
    'commcarehq.apps.reminders',
    'commcarehq.apps.translations',
    'commcarehq.apps.users',
    'commcarehq.apps.settings',
    'commcarehq.apps.ota',
    'commcarehq.apps.groups',
    'commcarehq.apps.mobile_auth',
    'commcarehq.apps.sms',
    'commcarehq.apps.smsforms',
    'commcarehq.apps.ivr',
    'commcarehq.apps.tropo',
    'commcarehq.apps.twilio',
    'commcarehq.apps.megamobile',
    'commcarehq.apps.kookoo',
    'commcarehq.apps.sislog',
    'commcarehq.apps.yo',
    'commcarehq.apps.telerivet',
    'commcarehq.apps.mach',
    'commcarehq.apps.registration',
    'commcarehq.apps.unicel',
    'commcarehq.apps.reports',
    'commcarehq.apps.reports_core',
    'commcarehq.apps.userreports',
    'commcarehq.apps.data_interfaces',
    'commcarehq.apps.export',
    'commcarehq.apps.builds',
    'commcarehq.apps.orgs',
    'commcarehq.apps.api',
    'commcarehq.apps.indicators',
    'commcarehq.apps.cachehq',
    'commcarehq.apps.toggle_ui',
    'commcarehq.apps.sofabed',
    'commcarehq.apps.hqpillow_retry',
    'commcarehq.couchapps',
    'commcarehq.preindex',
    ...
    'pillowtop',
    'pillow_retry',
    'commcarehq.apps.style',
    'commcarehq.apps.styleguide',
    'commcarehq.apps.grapevine',
    'commcarehq.apps.dashboard',
    'commcarehq.apps.public',
    'commcarehq.util',
...
FIXTURE_GENERATORS = {
    ...
    'standalone': [
        # core
        "commcarehq.apps.users.fixturegenerators.user_groups",
        "commcarehq.apps.fixtures.fixturegenerators.item_lists",
        "commcarehq.apps.callcenter.fixturegenerators.indicators_fixture_generator",
        "commcarehq.apps.products.fixtures.product_fixture_generator",
        "commcarehq.apps.programs.fixtures.program_fixture_generator",
        # custom
    ...
    'case': [
        "commcarehq.apps.locations.fixtures.location_fixture_generator",
    ]
}
...
COUCHLOG_RECORD_WRAPPER = "commcarehq.apps.hqcouchlog.wrapper"
...
AUDIT_MODEL_SAVE = [
    'commcarehq.apps.app_manager.Application',
    'commcarehq.apps.app_manager.RemoteApp',
]
AUDIT_VIEWS = [
    'commcarehq.apps.domain.views.registration_request',
    'commcarehq.apps.domain.views.registration_confirm',
    'commcarehq.apps.domain.views.password_change',
    'commcarehq.apps.domain.views.password_change_done',
    'commcarehq.apps.reports.views.submit_history',
    'commcarehq.apps.reports.views.active_cases',
    'commcarehq.apps.reports.views.submit_history',
    'commcarehq.apps.reports.views.default',
    'commcarehq.apps.reports.views.submission_log',
    'commcarehq.apps.reports.views.form_data',
    'commcarehq.apps.reports.views.export_data',
    'commcarehq.apps.reports.views.excel_report_data',
    'commcarehq.apps.reports.views.daily_submissions',
]
...
LOGGING = {
    ...
    'handlers': {
        ...
        'mail_admins': {
            ...
            'class': 'commcarehq.util.log.HqAdminEmailHandler',
        },
        'sentry': {
            'level': 'ERROR',
...
COMPRESS_PRECOMPILERS = (
   ('text/less', 'commcarehq.apps.style.precompilers.LessFilter'),
)
...
SMS_HANDLERS = [
    'commcarehq.apps.sms.handlers.forwarding.forwarding_handler',
    'custom.ilsgateway.tanzania.handler.handle',
    'custom.ewsghana.handler.handle',
    'commcarehq.apps.commtrack.sms.handle',
    'commcarehq.apps.sms.handlers.keyword.sms_keyword_handler',
    'commcarehq.apps.sms.handlers.form_session.form_session_handler',
    'commcarehq.apps.sms.handlers.fallback.fallback_handler',
]

SMS_LOADED_BACKENDS = [
    "commcarehq.apps.unicel.api.UnicelBackend",
    "commcarehq.apps.mach.api.MachBackend",
    "commcarehq.apps.tropo.api.TropoBackend",
    "commcarehq.apps.sms.backend.http_api.HttpBackend",
    "commcarehq.apps.telerivet.models.TelerivetBackend",
    "commcarehq.apps.sms.test_backend.TestSMSBackend",
    "commcarehq.apps.sms.backend.test.TestBackend",
    "commcarehq.apps.grapevine.api.GrapevineBackend",
    "commcarehq.apps.twilio.models.TwilioBackend",
    "commcarehq.apps.megamobile.api.MegamobileBackend",
]
...
CASE_WRAPPER = 'commcarehq.apps.hqcase.utils.get_case_wrapper'

PILLOWTOPS = {
    'core': [
        'commcarehq.pillows.case.CasePillow',
        'commcarehq.pillows.xform.XFormPillow',
        'commcarehq.pillows.domain.DomainPillow',
        'commcarehq.pillows.user.UserPillow',
        'commcarehq.pillows.application.AppPillow',
        'commcarehq.pillows.group.GroupPillow',
        'commcarehq.pillows.sms.SMSPillow',
        'commcarehq.pillows.user.GroupToUserPillow',
        'commcarehq.pillows.user.UnknownUsersPillow',
        'commcarehq.pillows.sofabed.FormDataPillow',
        'commcarehq.pillows.sofabed.CaseDataPillow',
    ],
    'phonelog': [
        'commcarehq.pillows.log.PhoneLogPillow',
    ],
    'core_ext': [
        'commcarehq.pillows.reportcase.ReportCasePillow',
        'commcarehq.pillows.reportxform.ReportXFormPillow',
        'commcarehq.apps.userreports.pillow.ConfigurableIndicatorPillow',
        'commcarehq.apps.userreports.pillow.CustomDataSourcePillow',
    ],
    'cache': [
        'commcarehq.pillows.cacheinvalidate.CacheInvalidatePillow',
    ],
    'fluff': [
...
COUCH_CACHE_BACKENDS = [
    'commcarehq.apps.cachehq.cachemodels.DomainGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.OrganizationGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.UserGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.GroupGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.UserRoleGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.TeamGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.ReportGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.DefaultConsumptionGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.LocationGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.DomainInvitationGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.CommtrackConfigGenerationCache',
    'commcarehq.apps.cachehq.cachemodels.UserReportsDataSourceCache',
    'commcarehq.apps.cachehq.cachemodels.UserReportsReportConfigCache',
